import { _decorator, Component, PhysicsContact, PhysicsCollider, log } from 'cc';
...
@ccclass('SteelBallComponent')
export default class SteelBallComponent extends Component {
  onLoad() {
...
//  // 只在两个碰撞体开始接触时被调用一次
  onBeginContact(
    ...
    log("SteelBallComponent：onBeginContact")
...
//  // 只在两个碰撞体结束接触时被调用一次
  onEndContact(
    ...
    log("SteelBallComponent：onEndContact")
  }
//  // 每次将要处理碰撞体接触逻辑时被调用
  onPreSolve(
    contact: PhysicsContact,
    ...
    log("SteelBallComponent：onPreSolve")
  }
//  // 每次处理完碰撞体接触逻辑时被调用
  onPostSolve(
    contact: PhysicsContact,
    ...
    log("SteelBallComponent：onPostSolve")
  }
}
