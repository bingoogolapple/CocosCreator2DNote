import { _decorator, Component, Node, Label, Action, Vec3, Color } from 'cc';
const { ccclass, property } = _decorator

@ccclass('Scene14Game')
export default class Scene14Game extends Component {
  @property(Node)
  spikeTopNode: Node | null = null
  @property(Node)
  enemyNode: Node | null = null
  @property(Node)
  playerNode: Node | null = null
  @property(Node)
  boomNode: Node | null = null
  @property(Label)
  scoreLabel: Label | null = null
  isFire: boolean = false
  fireAction: Action | null = null
  playerAction: Action | null = null
...
//    // 停止发射动画，否则 0.5s 后重置玩家位置后还会继续发射动画
  ...
  private boom(position: cc.Vec3, color: Color) {
