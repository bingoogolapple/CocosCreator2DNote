import { _decorator, Component, Label, Node, Prefab, Vec2 } from 'cc';
const { ccclass, property } = _decorator

import Scene16Block from "./Scene16Block"

@ccclass('Scene16Game')
export default class Scene16Game extends Component {
  ...
  private baseIndexCheck(pos: Vec2) {
