...
//  // 圆形抽象节点
  @property(Node)
  circleNode: Node | null = null
//  // 圆形转盘节点，用于实现选择动画
  @property(Node)
  turntableNode: Node | null = null
//  // 矩形抽奖节点
  @property(Node)
  rectNode: Node | null = null
//  // 获奖者1
  @property(Label)
  winner1Label: Label | null = null
//  // 获奖者2
  @property(Label)
  winner2Label: Label | null = null
//  // 圆形转盘中奖概率
...
//      // 3.0：-parentHeight
  ...
  private updateWinnerInfo(winnerLabel: Label) {
