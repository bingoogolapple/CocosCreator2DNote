import { _decorator, Component, Node, Label, Vec2, Action } from 'cc';
...
@ccclass('Scene13Game')
export default class Scene13Game extends Component {
  @property(Node)
  ...
  @property([Node])
  wallNodeArr: Node[] = []
  blockOriginPosition: Vec2 | null = null
  growAction: Action | null = null
...
//    // 场景编辑器中 left 节点的锚点在右下角，right 节点的锚点在左下角，所以直接用 right 的锚点 x 减 left 的锚点 x
  ...
  placeWall(node: Node, destX: number) {
        // node.runAction(
