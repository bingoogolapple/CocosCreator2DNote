import { _decorator, Component, Sprite, SpriteFrame, AudioClip, Vec2, Event } from 'cc';
...
//  // 炮塔
  ...
  cannonFrameNormal: SpriteFrame | null = null
  @property(SpriteFrame)
  cannonFramePressed: SpriteFrame | null = null
//  // 子弹图片
  @property(SpriteFrame)
...
//  // 音效
  @property(AudioClip)
  fireAudio: AudioClip | null = null
  @property(AudioClip)
  explodeAudio: AudioClip | null = null
